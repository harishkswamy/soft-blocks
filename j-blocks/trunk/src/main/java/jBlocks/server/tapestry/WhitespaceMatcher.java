...
public class WhitespaceMatcher implements ICharacterMatcher
{
    ...
    /**
     * Matches whitespace characters. Line terminators may be matched depending on the constructor used to create the
     * object.
     * 
     * @see jBlocks.server.tapestry.ICharacterMatcher#matches(char)
     */
