...
public interface ICharacterTranslator
{
     ...
     * @return null if the character is not to be translated, an empty string if the character is to be ignored, or
     *         another string to represent the character translation
     */
